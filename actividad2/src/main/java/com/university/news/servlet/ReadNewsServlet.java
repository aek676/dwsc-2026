...
public class ReadNewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean resultado = buffer.read(elemento);
            
            out.println("<html><head><title>Resultado READ</title></head><body>");
            if (resultado) {
                out.println("<h2>Noticia leida (sin extraer del buffer)</h2>");
                ...
                out.println("<p><em>Nota: La noticia sigue en el buffer.</em></p>");
            } else {
                out.println("<h2 style='color:red'>Error: Buffer vacio</h2>");
                out.println("<p>No hay noticias para leer.</p>");
            }
